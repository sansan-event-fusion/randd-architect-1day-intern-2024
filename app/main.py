...
if 'cards' not in st.session_state:
    st_cards = requests.get(url + 'cards/?offset=0&limit=2000')
...
if 'contacts' not in st.session_state:
    st_contacts = requests.get(url + 'contacts/?offset=0&limit=99439')
...
if user_id in cards_json and user_id != '' and phone_number!= '' and phone_number == cards_json[user_id]['phone_number']:
    ...
    for i, row in same_company_contacts.iterrows():
